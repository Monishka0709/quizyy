...
import {topic} from './QuizList'
import { questionsarray } from '../assets/data'
import 'react-toastify/dist/ReactToastify.css';
// import {topic} from '../components/QuizList'
...
const Quiz = () => {
    ...
    const data = questionsarray.filter(questionitem => questionitem.topic == topic)
    ...
    <div className='quiz--container'>
        ...
        {showNextBtn && <button className='nextbtn' onClick={reset} >Reset</button>}
        </>:<></>}
